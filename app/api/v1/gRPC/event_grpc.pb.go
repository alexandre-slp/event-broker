...
import (
	context "context"
	"github.com/alexandre-slp/event-broker/cmd/server/api/v1/serializer"
...
type EventClient interface {
	ListEvents(ctx context.Context, in *serializer.ListEventRequest, opts ...grpc.CallOption) (*serializer.ListEventResponse, error)
}
...
func (c *eventClient) ListEvents(ctx context.Context, in *serializer.ListEventRequest, opts ...grpc.CallOption) (*serializer.ListEventResponse, error) {
	out := new(serializer.ListEventResponse)
...
type EventServer interface {
	ListEvents(context.Context, *serializer.ListEventRequest) (*serializer.ListEventResponse, error)
...
func (UnimplementedEventServer) ListEvents(context.Context, *serializer.ListEventRequest) (*serializer.ListEventResponse, error) {
...
func _Event_ListEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(serializer.ListEventRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServer).ListEvents(ctx, req.(*serializer.ListEventRequest))
	}
...
var Event_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/api/event/event.proto",
}
